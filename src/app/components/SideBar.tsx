...
const SideBar = () => {
  ...
  return (
    <SidebarStyled theme={theme}>
      <div className="flex items-center justify-between gap-40 flex-col text-white ">
        <div className="">
          <div className="image">
            <Image
              ...
              width={70}
              height={70}
              className="rounded-full m-2 text-center cursor-pointer"
            />
          </div>
          <h1 className="m-2 ">
            <span>Aditya</span>
        ...
        <div>
          <ul className="text-center [&_li]:p-2 nav-items">
            <li>
            ...
            <li>
              <Link href={"/incompleted"}>Do It Now</Link>
            </li>
          </ul>
        </div>
        <div>
